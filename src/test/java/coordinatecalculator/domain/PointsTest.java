...
public class PointsTest {
    ...
    @Test
    public void 두_점_사이의_거리를_구할떄_직선이_아니면_예외_발생() throws Exception {
        //given
        Points points = new Points(Arrays.asList(19, 15));
        //then
        Assertions.assertThatThrownBy(points::getDistance)
